...
#     dict(
#         type="AV2DownsampleQuantizeInstanceDepthmap",
#         downsample=depthnet_config["stride"],
#         depth_config=depthnet_config,
#     ),
#     dict(
...
#             "img_backbone": dict(
#                 lr_mult=0.1
#             ),  # 0.5 only for Focal-PETR with R50-in1k pretrained weights
#         }
#     ),
#     weight_decay=0.01,
# )
